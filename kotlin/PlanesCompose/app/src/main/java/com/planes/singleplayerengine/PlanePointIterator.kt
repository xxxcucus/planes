...
class PlanePointIterator(pl: Plane) : VectorIterator<Coordinate2D>() {
    ...
    private fun generateList() {
        val pointsNorthSouth = arrayOf(
            Coordinate2D(0, 0), Coordinate2D(0, 1), Coordinate2D(-1, 1),
                Coordinate2D(1, 1), Coordinate2D(-2, 1), Coordinate2D(2, 1),
                Coordinate2D(0, 2), Coordinate2D(0, 3), Coordinate2D(-1, 3),
                Coordinate2D(1, 3)
        )
        val pointsSouthNorth = arrayOf(
            Coordinate2D(0, 0), Coordinate2D(0, -1), Coordinate2D(-1, -1),
                Coordinate2D(1, -1), Coordinate2D(-2, -1), Coordinate2D(2, -1),
                Coordinate2D(0, -2), Coordinate2D(0, -3), Coordinate2D(-1, -3),
                Coordinate2D(1, -3)
        )
        val pointsEastWest = arrayOf(
            Coordinate2D(0, 0), Coordinate2D(1, 0), Coordinate2D(1, -1),
                Coordinate2D(1, 1), Coordinate2D(1, -2), Coordinate2D(1, 2),
                Coordinate2D(2, 0), Coordinate2D(3, 0), Coordinate2D(3, -1),
                Coordinate2D(3, 1)
        )
        val pointsWestEast = arrayOf(
            Coordinate2D(0, 0), Coordinate2D(-1, 0), Coordinate2D(-1, -1),
                Coordinate2D(-1, 1), Coordinate2D(-1, -2), Coordinate2D(-1, 2),
                Coordinate2D(-2, 0), Coordinate2D(-3, 0), Coordinate2D(-3, 1),
                Coordinate2D(-3, -1)
