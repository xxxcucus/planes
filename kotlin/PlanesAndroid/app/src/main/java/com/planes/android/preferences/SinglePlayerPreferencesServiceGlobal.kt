...
class SinglePlayerPreferencesServiceGlobal : ISinglePlayerPreferencesService {
    ...
    companion object {
        private var global_Service: SinglePlayerPreferencesService? = null
    }

    fun createPreferencesService(context: Context) {
        if (global_Service != null) return
        global_Service = SinglePlayerPreferencesService(context)
    }
