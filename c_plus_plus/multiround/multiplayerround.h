...
private:
    ...
    CreateGameCommObj* m_CreateGameObj = nullptr;
    ConnectToGameCommObj* m_ConnectToGameObj = nullptr;
    RefreshGameStatusCommObj* m_RefreshGameStatusCommObj = nullptr;
    LoginCommObj* m_LoginCommObj = nullptr;
    RegisterCommObj* m_RegisterCommObj = nullptr;
    NoRobotCommObj* m_NoRobotCommObj = nullptr;
    SendPlanePositionsCommObj* m_SendPlanePositionsCommObj = nullptr;
    AcquireOpponentPositionsCommObj* m_AcquireOpponentPlanePositions = nullptr;
    SendMoveCommObj* m_SendMoveCommObj = nullptr;
    //RequestOpponentMovesCommObj* m_RequestOpponentMovesObj;
    CancelRoundCommObj* m_CancelRoundCommObj = nullptr;
    StartNewRoundCommObj* m_StartNewRoundCommObj = nullptr;
    SendWinnerCommObj* m_SendWinnerCommObj = nullptr;
    GetServerVersionCommObj* m_GetServerVersionCommObj = nullptr;
    LogoutCommObj* m_LogoutCommObj = nullptr;
    PlayersListCommObj* mPlayersListCommObj = nullptr;
    DeactivateUserCommObj* m_DeactivateUserCommObj = nullptr;
    ReceiveChatMessagesCommObj* m_ReceiveChatMessagesCommObj = nullptr;
    SendChatMessageCommObj* m_SendChatMessageCommObj = nullptr;
