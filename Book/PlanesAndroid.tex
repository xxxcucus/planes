...
What is special to this screen is the fact by clicking on the Submit button a network call is made to the game server. For the network call the Retrofit library. The asynchronous network calls are handled with the RxJava library.
...
\subsubsection { Network calls with Retrofit }
...
\subsubsection { Asynchronous calls with RxJava }
